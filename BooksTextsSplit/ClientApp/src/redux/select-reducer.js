        ...
        case SET_ALL_BOOKS_IDS:
            {
                ...
                return {...state, allFirstBookSentenceIds: action.allFirstBookSentenceIds };
            }
            case SET_SENTENCES:
                {
...
export const setAllBookIdsWithNames = (allFirstBookSentenceIds) => ({ type: SET_ALL_BOOKS_IDS, allFirstBookSentenceIds });
